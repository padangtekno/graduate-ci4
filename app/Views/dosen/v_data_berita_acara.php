                    ...
                    foreach ($mhs as $key => $value) {                     ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('DashboardDosen/cetakBeritaAcara/' . $value['id_mahasiswa']) ?>" target="_blank" class="btn btn-flat btn-xs btn-info"><i class="fas fa-print"></i> Cetak Berita Acara</a>
                            </td>
                        </tr>
                    <?php } ?>
